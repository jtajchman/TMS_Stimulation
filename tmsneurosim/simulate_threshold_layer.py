...
def simulate_combined_threshold_layer(layer: CorticalLayer, cells: List[NeuronCell], waveform_type: WaveformType,
...
def simulate_cell_thresholds(cell: NeuronCell, waveform_type: WaveformType, directions: List[NDArray[np.float64]],
                             positions: List[NDArray[np.float64]], azimuthal_rotations: NDArray[np.float64],
