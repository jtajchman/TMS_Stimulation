...
class L1_NGC_DA_bNAC(NeuronCell):
                ...
                list(
                    pathlib.Path(
                        str(
                            ...
                            .parent.joinpath(
                                "cells/cells_hoc/L1_NGC-DA_bNAC/morphology/"
                            )
                            .resolve()
                        )
                    )
    ...
    def get_morphology_ids():
        return sorted(
            [
                int(f.name)
                for f in pathlib.Path(
                    str(
                        pathlib.Path(tmsneurosim.nrn.__file__)
                        .parent.joinpath("cells/cells_hoc/L1_NGC-DA_bNAC/morphology/")
                        .resolve()
                    )
                ).iterdir()
                if f.is_dir()
    ...
    def apply_biophysics(self):
        ...
        for dend_section in self.dend:
            for dend_segment in dend_section.allseg():
                ...
                dend_segment.gK_Tstbar_K_Tst = (
                    0.0 * dend_segment_distance + 1.0
                ) * 0.001511
                dend_segment.gSKv3_1bar_SKv3_1 = (
                    0.0 * dend_segment_distance + 1.0
                ) * 0.000083
                dend_segment.gNap_Et2bar_Nap_Et2 = (
                    0.0 * dend_segment_distance + 1.0
                ) * 0.000000
                dend_segment.gNaTs2_tbar_NaTs2_t = (
                    0.0 * dend_segment_distance + 1.0
                ) * 0.000229
                dend_segment.gIhbar_Ih = (
                    -0.869600
                    + 2.087000 * math.exp((dend_segment_distance - 0.000000) * 0.003000)
                ) * 0.000049
        ...
        for apic_section in self.apic:
            for apic_segment in apic_section.allseg():
                ...
                apic_segment.gK_Tstbar_K_Tst = (
                    0.0 * apic_segment_distance + 1.0
                ) * 0.001511
                apic_segment.gSKv3_1bar_SKv3_1 = (
                    0.0 * apic_segment_distance + 1.0
                ) * 0.000083
                apic_segment.gNap_Et2bar_Nap_Et2 = (
                    0.0 * apic_segment_distance + 1.0
                ) * 0.000000
                apic_segment.gNaTs2_tbar_NaTs2_t = (
                    0.0 * apic_segment_distance + 1.0
                ) * 0.000229
                apic_segment.gIhbar_Ih = (
                    -0.869600
                    + 2.087000 * math.exp((apic_segment_distance - 0.000000) * 0.003000)
                ) * 0.000049
        ...
        for axon_section in self.axon:
            for axon_segment in axon_section.allseg():
                ...
                axon_segment.gNaTa_tbar_NaTa_t = (
                    0.0 * axon_segment_distance + 1.0
                ) * 3.999855
                axon_segment.gK_Tstbar_K_Tst = (
                    0.0 * axon_segment_distance + 1.0
                ) * 0.042115
                axon_segment.gamma_CaDynamics_E2 = (
                    0.0 * axon_segment_distance + 1.0
                ) * 0.001739
                axon_segment.gNap_Et2bar_Nap_Et2 = (
                    0.0 * axon_segment_distance + 1.0
                ) * 0.000001
                axon_segment.gCa_LVAstbar_Ca_LVAst = (
                    0.0 * axon_segment_distance + 1.0
                ) * 0.009017
                axon_segment.gSK_E2bar_SK_E2 = (
                    0.0 * axon_segment_distance + 1.0
                ) * 0.001224
                axon_segment.gK_Pstbar_K_Pst = (
                    0.0 * axon_segment_distance + 1.0
                ) * 0.001693
                axon_segment.gSKv3_1bar_SKv3_1 = (
                    0.0 * axon_segment_distance + 1.0
                ) * 0.386953
                axon_segment.decay_CaDynamics_E2 = (
                    0.0 * axon_segment_distance + 1.0
                ) * 468.069681
        ...
        for soma_section in self.soma:
            for soma_segment in soma_section.allseg():
                ...
                soma_segment.gK_Tstbar_K_Tst = (
                    0.0 * soma_segment_distance + 1.0
                ) * 0.039863
                soma_segment.gamma_CaDynamics_E2 = (
                    0.0 * soma_segment_distance + 1.0
                ) * 0.000500
                soma_segment.gNap_Et2bar_Nap_Et2 = (
                    0.0 * soma_segment_distance + 1.0
                ) * 0.000001
                soma_segment.gCa_LVAstbar_Ca_LVAst = (
                    0.0 * soma_segment_distance + 1.0
                ) * 0.003242
                soma_segment.gSK_E2bar_SK_E2 = (
                    0.0 * soma_segment_distance + 1.0
                ) * 0.000523
                soma_segment.gK_Pstbar_K_Pst = (
                    0.0 * soma_segment_distance + 1.0
                ) * 0.005446
                soma_segment.gSKv3_1bar_SKv3_1 = (
                    0.0 * soma_segment_distance + 1.0
                ) * 0.503893
                soma_segment.decay_CaDynamics_E2 = (
                    0.0 * soma_segment_distance + 1.0
                ) * 645.079741
                ...
                soma_segment.gNaTs2_tbar_NaTs2_t = (
                    0.0 * soma_segment_distance + 1.0
                ) * 0.150747
